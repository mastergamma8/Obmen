...
const i18n = {
     ru: {
            ...
            // МИНЫ
            mines_title: 'Мины',
            mines_desc: 'Избегай мин и забирай иксы!',
            mines_bet_label: 'Ставка (звёзды):',
            mines_mines_label: 'Количество мин:',
            mines_btn_start: 'Начать игру',
            mines_btn_cashout: 'Забрать',
            mines_btn_cancel: 'Отмена',
            mines_multiplier_label: 'Текущий множитель',
            mines_win_label: 'Выигрыш',
            mines_next_mult: 'Следующий шаг',
            mines_status_idle: 'Выберите ставку и начните игру',
            mines_status_active: 'Открывайте ячейки или забирайте выигрыш',
            mines_status_won: '🎉 Победа! Выигрыш зачислен',
            mines_status_lost: '💥 Вы попали на мину!',
            mines_err_no_game: 'Нет активной игры',
            mines_err_limits: 'Ставка от {min} до {max} звёзд',
            mines_err_not_enough: 'Недостаточно звёзд',
            mines_reveal_first: 'Откройте хотя бы одну ячейку',
            mines_game_over: 'Игра окончена',
            mines_new_game: 'Новая игра',
        ...
        en: {
            ...
            // MINES
            mines_title: 'Mines',
            mines_desc: 'Avoid the mines and collect multipliers!',
            mines_bet_label: 'Bet (stars):',
            mines_mines_label: 'Number of mines:',
            mines_btn_start: 'Start Game',
            mines_btn_cashout: 'Cash Out',
            mines_btn_cancel: 'Cancel',
            mines_multiplier_label: 'Current Multiplier',
            mines_win_label: 'Win Amount',
            mines_next_mult: 'Next Step',
            mines_status_idle: 'Choose a bet and start the game',
            mines_status_active: 'Reveal cells or cash out your winnings',
            mines_status_won: '🎉 Victory! Winnings credited',
            mines_status_lost: '💥 You hit a mine!',
            mines_err_no_game: 'No active game',
            mines_err_limits: 'Bet from {min} to {max} stars',
            mines_err_not_enough: 'Not enough stars',
            mines_reveal_first: 'Reveal at least one cell first',
            mines_game_over: 'Game Over',
            mines_new_game: 'New Game',
