...
const i18n = {
     ru: {
            ...
            // МИНЫ
            mines_title: 'Мины',
            mines_banner_desc: 'Открывай клетки — не попади на мину!',
            mines_multiplier: 'Множитель',
            mines_potential: 'Выигрыш',
            mines_select_mines: 'Мин на поле:',
            mines_bet_label: 'Ставка:',
            mines_start: 'Начать игру',
            mines_starting: 'Запускаем...',
            mines_cashout_btn: 'Забрать',
            mines_win_title: 'Вы выиграли!',
            mines_lose_title: 'Мина! 💥',
            mines_lose_msg: 'Потеряно {amount}',
            mines_bet_limits: 'Ставка от {min} до {max} ⭐',
            mines_cashout_before_exit: 'Заберите выигрыш перед выходом!',
            mines_demo: 'Демо',
            hist_mines_bet: 'Мины: ставка',
            hist_mines_win: 'Мины: выигрыш',
            hist_mines_lose: 'Мины: проигрыш',
        ...
        en: {
            ...
            // MINES
            mines_title: 'Mines',
            mines_banner_desc: 'Open cells — don\'t hit a mine!',
            mines_multiplier: 'Multiplier',
            mines_potential: 'Win',
            mines_select_mines: 'Mines count:',
            mines_bet_label: 'Bet:',
            mines_start: 'Start Game',
            mines_starting: 'Starting...',
            mines_cashout_btn: 'Cash Out',
            mines_win_title: 'You Won!',
            mines_lose_title: 'Mine Hit! 💥',
            mines_lose_msg: 'Lost {amount}',
            mines_bet_limits: 'Bet from {min} to {max} ⭐',
            mines_cashout_before_exit: 'Cash out before leaving!',
            mines_demo: 'Demo',
            hist_mines_bet: 'Mines: bet',
            hist_mines_win: 'Mines: win',
            hist_mines_lose: 'Mines: loss',
